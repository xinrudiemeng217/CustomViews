...
import com.custom.view.view.badgeview.Badge;
import com.custom.view.view.badgeview.QBadgeView;

import java.util.ArrayList;
import java.util.List;

/**
 * @author https://github.com/qstumn/BadgeView
 */
public class BadgeViewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(QBadgeView.class.getSimpleName());
    ...
    private void selectorColor(final OnColorClickListener l) {
        ...
        gv.setAdapter(new BaseAdapter() {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                View v = new View(BadgeViewActivity.this);
                ...
                WindowManager wm = (WindowManager) BadgeViewActivity.this
